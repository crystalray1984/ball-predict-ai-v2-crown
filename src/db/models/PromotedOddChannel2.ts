 ...
 * 最终推荐盘口表
 */
@Table({ tableName: 'promoted_odd_channel2' })
export class PromotedOddChannel2 extends Model<
    InferAttributes<PromotedOddChannel2>,
    InferCreationAttributes<PromotedOddChannel2>
> {
    /**
     * 盘口id
     */
